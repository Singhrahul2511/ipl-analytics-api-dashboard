...
## this is like searching any name to be appear result player_aliases and team
player_names = list(set(
    balls['batter'].dropna().unique().tolist() +
    balls['bowler'].dropna().unique().tolist() +
    balls['player_out'].dropna().unique().tolist()
))
